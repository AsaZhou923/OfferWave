...
(
    ...
    unique_hash      char(32)                              not null comment '规范化公司名|职位名|城市的 MD5',
...
values (1, '普通用户', 0.00, -1, json_object('max_job_track', 5), null),
       (2, 'VIP会员', 0.00, 30, json_object('max_job_track', -1), null);
...
(
    ...
    is_collected    tinyint    default 0                 null comment '是否收藏 (TRUE: 是, FALSE: 否)',
